    ...
    public async Task<AiSummaryResult> SummarizeAsync(IncidentDetailDto incident, CancellationToken ct)
    {
        ...
        var messages = new List<ChatMessage>
        {
            new SystemChatMessage(
                ...
                "SummaryMarkdown should be generated in markdown format.\n" +
                "Do not include a citation list in the markdown."),
            new UserChatMessage(
    ...
    public async Task<AiPostmortemDraftResult> DraftPostmortemAsync(IncidentDetailDto incident, CancellationToken ct)
    {
        ...
        var messages = new List<ChatMessage>
        {
            new SystemChatMessage(
                ...
                "Return ONLY a JSON object that matches the provided JSON schema. " +
                "Citations must reference provided sequence values in the format [sequence] or [sequence1, sequence2,..., sequenceN], without (), but not incidentEventId." +
                "DraftMarkdown should be generated in markdown format.\n" +
                "Do not include a citation list in the markdown."),
            new UserChatMessage(
